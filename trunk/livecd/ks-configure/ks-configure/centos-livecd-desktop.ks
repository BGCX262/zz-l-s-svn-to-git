...
selinux --enforcing
firewall --enabled
repo --name=a-base    --baseurl=http://mirrors.163.com/centos/5.4/os/$basearch
repo --name=a-updates --baseurl=http://mirrors.163.com/centos/5.4/updates/$basearch
repo --name=a-extras  --baseurl=http://mirrors.163.com/centos/5.4/extras/$basearch
